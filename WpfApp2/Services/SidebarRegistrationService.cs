...
namespace Som3a_WPF_UI.Services
{
    public class SidebarRegistrationService : ISidebarRegistrationProvider
    {
        ...
        public void RegisterStaticPages()
        {
            ...
            _navigationService.RegisterPage("Planning", typeof(Pages.PrimaveraResultsPage), "planning.primavera.results", "Primavera Results", "Document", 30);
            _navigationService.RegisterPage("Planning", typeof(Pages.XerEditorPage), "planning.xereditor", "XER Editor", "Code", 40);
            _navigationService.RegisterPage("Planning", typeof(Pages.WBS.WBSTemplateBrowserPage), "planning.wbs.browser", "WBS Templates", "ListTree", 50);
            _navigationService.RegisterPage("Planning", typeof(Pages.WBS.WBSGeneratorPage), "planning.wbs.generator", "WBS Generator", "Add", 60);
            _navigationService.RegisterPage("Planning", typeof(Pages.WBS.WBSEditorPage), "planning.wbs.editor", "WBS Editor", "Drawer", 70);
            _navigationService.RegisterPage("Planning", typeof(Pages.BOQActivityGeneratorPage), "planning.boq.activity", "BOQ Activity Generator", "Add", 80);
            _navigationService.RegisterPage("Planning", typeof(Pages.RelationshipGeneratorPage), "planning.relationship", "Relationship Generator", "Link", 90);
            _navigationService.RegisterPage("Planning", typeof(Pages.DurationEstimatorPage), "planning.duration", "Duration Estimator", "History", 100);
            _navigationService.RegisterPage("Analysis", typeof(Pages.FloatPathPage), "analysis.floatpath", "Float Path", "Routes", 10);
            _navigationService.RegisterPage("Excel", typeof(Pages.LinksManagerPage), "excel.links", "Links Manager", "LinkMultiple", 10);
            _navigationService.RegisterPage("Excel", typeof(Pages.SubDailyReportPage), "excel.subdaily", "Sub-Daily Report", "Table", 20);
            _navigationService.RegisterPage("Excel", typeof(Pages.AssignTradeCodesPage), "excel.tradecodes", "Assign Trade Codes", "Tag", 30);
            _navigationService.RegisterPage("Excel", typeof(Pages.FixPieColorsPage), "excel.piecolors", "Fix Pie Colors", "Colors", 40);
            _navigationService.RegisterPage("Excel", typeof(Pages.StyleSelectorPage), "excel.styles", "Style Selector", "PaintBrush", 50);
            ...
            _navigationService.RegisterPage("Settings", typeof(Pages.SettingsPage), "settings.general", "Settings", "Settings", 10);
            _navigationService.RegisterPage("Settings", typeof(Pages.Settings.LanguagePage), "settings.language", "Language", "Translate", 15);
            _navigationService.RegisterPage("Settings", typeof(Pages.DiagnosticsPage), "diagnostics", "Diagnostics", "System", 99);
